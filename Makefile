...
clean: clean-ms-parser clean-bc-parser clean-ref clean-bc-compiler
...
bc-compiler: bc/* gc/*
	g++ -g -std=c++1y bc/compiler-main.cpp bc/bc-compiler.cpp bc/symboltable.cpp gc/gc.cpp frame.cpp types.cpp $(MS_PARSER_SRC) -o mitscriptc
