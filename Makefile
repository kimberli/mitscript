...
ms-print: $(MS_PARSER)/print_main.cpp $(MS_PARSER)/parser.cpp $(MS_PARSER)/lexer.cpp
	g++ -O2 -g -std=gnu++11 $(MS_PARSER)/print_main.cpp $(MS_PARSER)/parser.cpp $(MS_PARSER)/lexer.cpp -o $(MS_PARSER)/mitscript-print
...
clean-ms-parser:
	rm -f $(MS_PARSER)/lexer.cpp $(MS_PARSER)/lexer.h $(MS_PARSER)/parser.cpp $(MS_PARSER)/parser.h $(MS_PARSER)/parser.output $(MS_PARSER)/mitscript-print
